...
<body>
  ...
  <div class="container" style="margin-top: 50px;">
    <div class="row justify-content-center align-items-center">
      <div class="col-md-6">
        <h3 class="header" style="text-align:center">Update Student</h3>

        <form class="updateForm" id="updateForm" method="post">
          <div class="mb-3">
            <label for="rollNo" class="form-label">Roll Number</label>
            <input type="number" class="form-control is-valid" id="rollNo" placeholder="enter roll number" readonly>
      ...
      <option value=" 2nd">2nd</option>
          ...
          <button type="submit" style="width: 100%;" id="submitButton" class="btn btn-primary">Update</button>
        </form>
      </div>
    </div>
  </div>
  ...
  <script>
    $(document).ready(function() {
      ...
      var rollNo = urlParams.get('rollNo');
      ...
      // Set input field values with the retrieved data
      $('#rollNo').val(rollNo);
      $('#firstName').val(name);
      $('#lastName').val(surname);
      $('#datepicker').val(formattedDate);
      $('#gender').val(gender);
      $('#class').val(classValue);
    });
  </script>
